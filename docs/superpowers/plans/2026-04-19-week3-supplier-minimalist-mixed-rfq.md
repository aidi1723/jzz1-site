...
```bash
rg -n "singapore-minimalist-sliding-doors-for-condos|malaysia-tropical-coastal-window-spec-checklist|indonesia-mixed-window-and-door-rfq-checklist" /Users/aidi/ai启蒙电影/谷歌seo/.site-work/jzz1-site
```
