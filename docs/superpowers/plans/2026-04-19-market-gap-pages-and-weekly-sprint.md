...
```bash
rg -n "singapore-balcony-door-acoustic-spec-checklist|malaysia-commercial-window-and-balcony-door-rfq-guide|indonesia-apartment-window-package-rfq-guide" <jzz1-site-worktree>
```
